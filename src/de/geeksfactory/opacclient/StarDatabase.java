...
public class StarDatabase extends SQLiteOpenHelper {
	...
	private static final int DATABASE_VERSION = 3; // REPLACE ONUPGRADE IF YOU CHANGE THIS
	
	private static final String DATABASE_CREATE = "create table "
			+ "starred ( id integer primary key autoincrement,"
			+ " medianr text unique on conflict replace,"
			+ " bib text,"
			+ " title text"
			+ ");";
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		Log.w(StarDatabase.class.getName(),
