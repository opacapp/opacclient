...
public class AppCompatProgressDialog extends AlertDialog {
     ...
     * default is "%1d/%2d". Should not be called during the number is progressing.
     *
     ...
     * NumberFormat#getPercentInstance() NumberFormat.getPercentageInstnace().} Should not be called
